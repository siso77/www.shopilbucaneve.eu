...
dhx.Type(dhx.ui.pagelist, {
	...
	template:function(obj){
		return "<div class='tmp_products'><img class='tmp_products_img' src='"+window.getImage(obj)+"'><div class='tmp_products_title'><div class='price'>&euro; "+obj.price+"</div></div></div>";
	}
});
...
function booksTemplate(obj,arrow){
	...
	html += '<div class="book_price">Prezzo: ';
//	if(obj.oldprice)
