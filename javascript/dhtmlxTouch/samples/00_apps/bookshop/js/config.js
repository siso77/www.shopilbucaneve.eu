	...
	rows:[
		{
			...
			template:function(obj,common){
				...
				html += '<div class="book_price_tmp">Prezzo: ';
//				if(obj.old_price)
//						html += '<div class="book_old_price_in">&euro; '+obj.oldprice+'</div>';
				html += '<div class="book_price_in">&euro; '+obj.price+'</div>';
				html += '</div>';
		 ...
		 /*"mainBar" toolbar*/
			...
			elements:[
				{ view:"segmented", id:"tabs",multiview:true, selected:"storeProducts",batch:"store", options:[
			   		{value:"storeHotDeals", label:"Lista"},
		       		{value:"storeProducts", label:"Griglia"},
		       		{value:"storeGenres", label:"Categorie"}
				]},
				{view:"button", id:"back", css:"back",batch:"back",value:"Indietro",width:100},
