...
class ecm_ordini_magazzino extends BeanBase
{
	...
	function getImporto_prodotto(){return $this->importo_prodotto;}
	
	function setImporto_prodotto($value= null)
	{
		if(strlen($value) > 255)
			$value = substr($value, 0, 255);
	
	
		$this->importo_prodotto = (string)$value;
	}
