...
class agenti extends BeanBase
{
	var $id;
	var $codice_agente;
	var $nominativo;

	function agenti($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "agenti";
	...
	function getNominativo(){return $this->nominativo;}

	function setNominativo($value= null)
	{
