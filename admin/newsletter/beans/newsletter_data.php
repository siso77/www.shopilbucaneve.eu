...
class newsletter_data extends BeanBase
{
	var $id;
	var $titolo;
	var $news;

	function newsletter_data($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "newsletter_data";
	...
	function setTitolo($value= null)
	{
				
								
		$this->titolo = (string)$value;
	}

	function getNews(){return $this->news;}

	function setNews($value= null)
	{
				
								
		$this->news = (string)$value;
	}
