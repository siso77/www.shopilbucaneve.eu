...
class newsletters_to_newsletter_data extends BeanBase
{
	var $id_newsletter;
	var $id_newsletter_data;

	function newsletters_to_newsletter_data($conn=null, $id=null)
	{
		parent::BeanBase();
		
		$this->table_name = "newsletters_to_newsletter_data";
	...
	/*			GET e SET		*/	
	function getId_newsletter(){return $this->id_newsletter;}

	function setId_newsletter($value= null)
	{
				if(strlen($value) > 11)
			$value = substr($value, 0, 11);
				
								
		$this->id_newsletter = (int)$value;
	}

	function getId_newsletter_data(){return $this->id_newsletter_data;}

	function setId_newsletter_data($value= null)
	{
				if(strlen($value) > 11)
			$value = substr($value, 0, 11);
				
								
		$this->id_newsletter_data = (int)$value;
	}
